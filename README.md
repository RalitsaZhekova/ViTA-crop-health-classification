...
The Jetson production path builds an FP16 TensorRT cloud engine and an IEEE FP32
TensorRT crop engine on the target Orin, validates them against PyTorch, and runs all four
