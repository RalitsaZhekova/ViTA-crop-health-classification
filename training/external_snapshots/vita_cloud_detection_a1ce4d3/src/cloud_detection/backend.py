...
class CloudSEN12Backend:
    ...
    def __init__(
        ...
        weights_folder: str = "models/pretrained",
        device: str = "auto",
    ) -> None:
        if name != "dtacs4bands":
        ...
        try:
            ...
            raise BackendError(
                ...
                "scripts/download_weights.py while online and retry."
            ) from exc
    ...
    def predict(self, tile: np.ndarray) -> BackendPrediction:
            ...
            try:
                ...
                if logits_numpy.ndim == 3 and logits_numpy.shape[0] == 4:
                    return BackendPrediction(
                        ...
                        score_kind="softmax_probability",
                    )
            except Exception:
                pass
        ...
        if semantic.ndim != 2 or semantic.min() < 0 or semantic.max() > 3:
